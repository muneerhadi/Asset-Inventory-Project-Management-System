...
const submitSearch = () => {
    router.get(route('search.items'), { q: search.value }, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
    });
